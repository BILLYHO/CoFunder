...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!isRegNib)
	{
        [tableView registerNib:[UINib nibWithNibName:@"CFDetailCell" bundle:nil] forCellReuseIdentifier:detailCell];
        isRegNib = YES;
    }
    ...
    //[cell.contentLabel setFrame:CGRectMake(10, 10, 320 - (20 * 2), size.height)];
